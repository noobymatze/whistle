...
defmodule Seeds.Helpers do
  def create_user!(attrs) do
    ...
    if existing do
      ...
      |> Ecto.Changeset.put_change(:confirmed_at, NaiveDateTime.truncate(NaiveDateTime.utc_now(), :second))
      |> Repo.insert!()
    end
  end
end
...
[hsv, st_pauli, altona, teutonia, eimsbuettel, kiel, luebeck, werder, oberneuland, hannover] = clubs
...
users_data = [
  ...
  {"richter_claudia", "claudia.richter@example.de", "Claudia", "Richter", ~D[1989-01-25], st_pauli.id},
]

users =
  Enum.map(users_data, fn {username, email, first, last, birthday, club_id} ->
    u = Seeds.Helpers.create_user!(%{
      username: username,
      email: email,
      first_name: first,
      last_name: last,
...
[mueller, schmidt, weber, fischer, wagner, becker, hoffmann, schulz, braun, klein, wolf, richter] = users
...
seasons_data = [
  {2024, ~D[2024-01-01],
   ~N[2023-10-01 00:00:00], ~N[2023-12-31 23:59:59]},
  {2025, ~D[2025-01-01],
   ~N[2024-10-01 00:00:00], ~N[2024-12-31 23:59:59]},
  {2026, ~D[2026-01-01],
   ~N[2025-10-01 00:00:00], ~N[2026-06-30 23:59:59]},
]
...
if Repo.aggregate(Whistle.Exams.Question, :count) == 0 do
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "low", status: "active", scoring_mode: "exact_match",
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "low", status: "active", scoring_mode: "exact_match",
      body_markdown: "Wie viele Feldspieler darf eine Mannschaft gleichzeitig auf dem Spielfeld haben?"},
    ["F"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "medium", status: "active", scoring_mode: "exact_match",
      body_markdown: "Ein Spieler hebt den Stock beim Schuss über **Schulterhöhe**. Was entscheidet der Schiedsrichter?"},
    ["F"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "multiple_choice", difficulty: "medium", status: "active", scoring_mode: "partial_credit",
      body_markdown: "Welche der folgenden Vergehen führen typischerweise zu einer **2-Minuten-Zeitstrafe** im Unihockey?"},
    ["F"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "high", status: "active", scoring_mode: "exact_match",
      body_markdown: "Ein Spieler schießt aufs Tor. Der Ball trifft den **Pfosten**, prallt auf den Rücken des Torwarts und geht ins Tor. Zählt das Tor?"},
    ["F"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "high", status: "active", scoring_mode: "exact_match",
      body_markdown: "Ein Spieler steht beim **Penalty** zu früh im Spielfeld (vor dem Mittelpunkt). Was passiert, wenn er das Tor trifft?"},
    ["F"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "multiple_choice", difficulty: "high", status: "active", scoring_mode: "partial_credit",
      body_markdown: "Welche Vergehen können im Unihockey zu einer **5-Minuten-Strafe** oder einem **Spielausschluss** führen?"},
    ["F"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "high", status: "active", scoring_mode: "exact_match",
      body_markdown: "Der Schiedsrichter pfeift **versehentlich** ab, während ein Spieler auf das leere Tor zielt. Wie wird das Spiel fortgesetzt?"},
    ["F"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "low", status: "active", scoring_mode: "exact_match",
      body_markdown: "Wie lange dauert ein Unihockey-Spiel in der **U13-Jugend** nach IFF-Empfehlung?"},
    ["J"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "low", status: "active", scoring_mode: "exact_match",
      body_markdown: "Was ist beim Schiedsrichtern in **Jugendspielen** im Unihockey besonders zu beachten?"},
    ["J"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "low", status: "active", scoring_mode: "exact_match",
      body_markdown: "Ab welchem **Jahrgang** darf im Unihockey eine offizielle Zeitstrafe verhängt werden?"},
    ["J"],
    [
      {"Ab U13", true, 1},
      {"Ab U10", false, 2},
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "low", status: "active", scoring_mode: "exact_match",
      body_markdown: "Ein Jugendspieler (U13) beschwert sich lautstark über eine Entscheidung. Wie reagiert der Schiedsrichter idealerweise?"},
    ["J"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "low", status: "active", scoring_mode: "exact_match",
      body_markdown: "Darf ein Jugendspieler (U16) bei einem Turnier auch in der **U19** eingesetzt werden?"},
    ["J"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "multiple_choice", difficulty: "medium", status: "active", scoring_mode: "partial_credit",
      body_markdown: "Welche der folgenden **Vereinfachungen** gelten typischerweise in der **U10** im Unihockey?"},
    ["J"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "medium", status: "active", scoring_mode: "exact_match",
      body_markdown: "Ein U13-Jugendspieler erhält seine zweite **Zeitstrafe** im selben Spiel. Was folgt?"},
    ["J"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "high", status: "active", scoring_mode: "exact_match",
      body_markdown: "In einem **U16**-Spiel fällt der einzige Schiedsrichter aus. Was kann das Ergebnis sein?"},
    ["J"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "high", status: "active", scoring_mode: "exact_match",
      body_markdown: "Ein **U19**-Spieler wird kurz vor seinem 19. Geburtstag eingesetzt. Darf er nach dem Geburtstag noch in der U19 spielen?"},
    ["J"],
    [
  ...
  Seeds.Questions.create!(
    ...
    ["G"],
    [
      {"Freistoß für die nicht zuletzt berührende Mannschaft an der Stelle, wo der Ball die Bande verließ", true, 1},
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "low", status: "active", scoring_mode: "exact_match",
      body_markdown: "Wie viele **Schiedsrichter** leiten ein offizielles Unihockey-Spiel nach IFF-Regeln?"},
    ["G"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "low", status: "active", scoring_mode: "exact_match",
      body_markdown: "Wie lange dauert eine **Pause** zwischen den Dritteln beim Unihockey-Turnier?"},
    ["G"],
    [
      {"10 Minuten", true, 1},
      {"5 Minuten", false, 2},
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "medium", status: "active", scoring_mode: "exact_match",
      body_markdown: "Was geschieht beim Turnier, wenn ein Spieler nach einer **Zeitstrafe** zu früh das Strafbankbereich verlässt?"},
    ["G"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "medium", status: "active", scoring_mode: "exact_match",
      body_markdown: "Bei einem Unihockey-Turnier erhält Team A insgesamt **6 Zeitstrafen** in einem Drittel. Was kann der Schiedsrichter anordnen?"},
    ["G"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "multiple_choice", difficulty: "medium", status: "active", scoring_mode: "partial_credit",
      body_markdown: "Welche **Unterschiede** gelten beim Unihockey-Turnier gegenüber einem normalen Spielbetrieb?"},
    ["G"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "high", status: "active", scoring_mode: "exact_match",
      body_markdown: "Ein Spieler beim Turnier schlägt den Ball absichtlich **über die Bande**. Was entscheidet der Schiedsrichter?"},
    ["G"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "high", status: "active", scoring_mode: "exact_match",
      body_markdown: "Ein Spieler beim Turnier erhält eine **5-Minuten-Strafe**. Wie lange muss sein Team in Unterzahl spielen?"},
    ["G"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "multiple_choice", difficulty: "high", status: "active", scoring_mode: "partial_credit",
      body_markdown: "Welche **Anforderungen** gelten für einen Schiedsrichter beim Unihockey-Turnier besonders?"},
    ["G"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "low", status: "active", scoring_mode: "exact_match",
      body_markdown: "Welche Farbe hat das **Trikot** der Schiedsrichter im Unihockey üblicherweise?"},
    ["F", "J", "G"],
    [
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "low", status: "draft", scoring_mode: "exact_match",
  ...
  Seeds.Questions.create!(
    %{type: "single_choice", difficulty: "low", status: "archived", scoring_mode: "exact_match",
      body_markdown: "**Archiviert:** Diese Frage wurde deaktiviert und wird nicht mehr verwendet."},
    ["F"],
    [
      {"Antwort A", true, 1},
      {"Antwort B", false, 2},
...
if Repo.aggregate(Whistle.Courses.Course, :count) == 0 do
  ...
  {:ok, exam_waiting} = Exams.create_exam(f2026, Enum.map([mueller, schmidt, weber, fischer, wagner], & &1.id), admin.id, title: "F-Prüfung Mai 2026 (Gruppe A)")
  IO.puts("  Erstellt: #{exam_waiting.title} [#{exam_waiting.state}]")

  # Exam 2: currently running
  {:ok, exam_running} = Exams.create_exam(f2026, Enum.map([becker, hoffmann, schulz, braun, klein], & &1.id), admin.id, title: "F-Prüfung Mai 2026 (Gruppe B)")
  ...
  {:ok, exam_finished} = Exams.create_exam(f2026b, Enum.map([wolf, richter, mueller, weber], & &1.id), admin.id, title: "F-Prüfung April 2026")
  ...
  {:ok, exam_j} = Exams.create_exam(j2026, Enum.map([fischer, wagner, becker, hoffmann, schulz], & &1.id), admin.id, title: "J-Prüfung Mai 2026")
  IO.puts("  Erstellt: #{exam_j.title} [#{exam_j.state}]")

  # Exam 5: canceled
  {:ok, exam_canceled} = Exams.create_exam(g2026, Enum.map([braun, klein], & &1.id), admin.id, title: "G-Prüfung April 2026")
