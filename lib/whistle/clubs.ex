defmodule Whistle.Clubs do
  ...
  """
  def list_clubs do
    Repo.all(from c in Club, order_by: [asc: c.name])
  end
  ...
  @doc """
  Returns a mapping of club id to club name. This can be
  used to display clubs based on referenced ids.

  ## Examples

      iex> get_clubs_as_map()
      %{1 => "Test", 2 => "Foo"}
  """
  def get_clubs_as_map() do
    list_clubs()
    |> Map.new(fn club -> {club.id, club.name} end)
  end
end
