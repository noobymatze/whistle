defmodule WhistleWeb.Router do
  use WhistleWeb, :router

  import WhistleWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {WhistleWeb.Layouts, :root}
  ...
  # scope "/api", WhistleWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:whistle, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: WhistleWeb.Telemetry
  ...
  scope "/", WhistleWeb do
    ...
    get "/users/settings/clubs/select", ClubSelectionController, :index
    get "/users/settings/clubs/select/:club_id", ClubSelectionController, :select_club
  end

  scope "/", WhistleWeb do
    pipe_through [:browser, :require_authenticated_user, :require_club]
  ...
  scope "/", WhistleWeb do
    ...
    live_session :course_area,
      ...
      live "/admin/exam-variants", ExamVariantLive, :index
      live "/admin/exam-variants/new", ExamVariantLive, :new
      live "/admin/exam-variants/:id/edit", ExamVariantLive, :edit
    end
  end
